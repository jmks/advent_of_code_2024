defmodule AdventOfCode2024.Day10 do
  ...
  def parse(topomap) do
    AdventOfCode2024.Parsers.Tiles.parse(topomap, &String.to_integer/1)
    |> Enum.into(Map.new())
  end
  ...
  defp dfs([{location, path} | rest], map, trails) do
    ...
    if location_height == 9 do
      ...
      new_trails = for loc <- next_locations(location, target_height, map), do: {loc, [location | path]}
